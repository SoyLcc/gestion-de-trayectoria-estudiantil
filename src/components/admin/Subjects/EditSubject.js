...
export default class EditSubject extends Component {
    ...
    handleSubmit(e) {
        ...
        if (confirmed) {
            ...
            axios.put(`${API_URL}/subjects/${id}`, this.state)
                ...
                <div className="row mt-4">
                    ...
                    <div className="col-8">
                        <div className="card text-center" style={{border: "1px solid rgba(0,0,0,.160)"}}>
                            <h5 className="card-header">Editar Materia</h5>
                            <form className="needs-validation" onSubmit={this.handleSubmit}>
                                ...
                                <div className="card-footer">
                                    <Button type="submit" variant="success" size="sm" className="float-right mb-2">Guardar Materia</Button>
                                </div>
                            </form>
                        </div>
                    </div>
